          ...
          <Row>
            <Col xs={4} className='avatar'>
              ...
              <div className="social">
                ...
                {siteConfig.social.linkedin && <a className="social-link linkedin" rel="noreferrer" target="_blank" href={siteConfig.social.linkedin}>
                  <FaLinkedin className="social-icon" size="32" />
                </a>}
                {siteConfig.social.twitter && <a className="social-link twitter" rel="noreferrer" target="_blank" href={siteConfig.social.twitter}>
                  <FaTwitter className="social-icon" size="32" />
                </a>}
                {siteConfig.social.email && <a className="social-link email" rel="noreferrer" target="_blank" href={`mailto:${siteConfig.social.email}`}>
